      ...
      <div className="bg-primary text-white p-4 max-w-7xl mx-auto">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
          ...
          <Link href="/" className="flex items-center space-x-2 mb-4 md:mb-0">
            <Image src={logo} alt="Blonwe Logo " className='max-w-[200px] h-auto'  />
          </Link>
          ...
          <div className="flex flex-wrap items-center justify-between py-4">
            <div className="flex flex-wrap items-center space-x-4 md:space-x-8">
              ...
              <div className="relative group">
                <a href="#" className="flex items-center text-gray-500 hover:text-[#003B95]">
                  Shop
                ...
                <div className="absolute z-10 hidden group-hover:block bg-white border rounded-md mt-2 py-2 w-48">
                  <a href="#" className="block px-4 py-2 text-gray-500 hover:bg-gray-100">New Arrivals</a>
                  <a href="#" className="block px-4 py-2 text-gray-500 hover:bg-gray-100">Best Sellers</a>
                  <a href="#" className="block px-4 py-2 text-gray-500 hover:bg-gray-100">Sale Items</a>
                </div>
              </div>

              <a href="/furniture" className="flex items-center text-gray-500 hover:text-[#003B95]">
                <span className="mr-2"><TbArmchair /></span> Furniture
              </a>

              <a href="/electronics" className="flex items-center text-gray-500 hover:text-[#003B95]">
                <span className="mr-2"><ImMobile2 /></span> Electronics
              </a>

              <a href="/fashion" className="flex items-center text-gray-500 hover:text-[#003B95]">
                <span className="mr-2"><PiDress /></span> Fashion
              </a>
              ...
              <div className="relative group">
                <a href="#" className="flex items-center text-gray-500 hover:text-[#003B95]">
                  <span className="mr-2"><CiDiscount1 /></span> Best Discounts
                  <svg xmlns="http://www.w3.org/2000/svg" className="ml-1 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                </a>
                <div className="absolute z-10 hidden group-hover:block bg-white border rounded-md mt-2 py-2 w-48">
                  <a href="#" className="block px-4 py-2 text-gray-800 hover:bg-gray-100">Daily Deals</a>
                  <a href="#" className="block px-4 py-2 text-gray-800 hover:bg-gray-100">Clearance</a>
                  <a href="#" className="block px-4 py-2 text-gray-800 hover:bg-gray-100">Season Special</a>
                </div>
              </div>
            </div>
