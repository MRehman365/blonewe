...
export default function ProductDetail({handleClosePopup}) {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto bg-[#fff] shadow-lg rounded-lg  z-50 max-h-[90vh] overflow-auto">
      <div className="p-6">
        <div className="flex justify-between items-start mb-6">
          <div>
            <h1 className="text-2xl font-bold text-black">BY WIRTH — SCALA SKAMMEL — FLERE VARIANTER</h1>
            <div className="flex items-center gap-2 mt-2">
              ...
              <span className="text-gray-600">Store: machic</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <button className="w-full text-black py-2 px-4 rounded flex  justify-start items-center gap-2">
              <FaHeart className="h-4 w-4" />
              Add to wishlist
            </button>

            <div className="border-t pt-4">
              <p className="text-sm text-gray-600">SKU: F7S6G8T9S1</p>
              <p className="text-sm text-gray-600">Categories: Furniture, Table</p>
              <p className="text-sm text-gray-600">Tags: chair, table</p>
            </div>
