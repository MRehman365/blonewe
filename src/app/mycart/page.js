          ...
          <div className="mb-6">
            ...
            <div className="space-y-4">
              {products.map((product) => (
                <div key={product.id} className="grid grid-cols-3 md:grid-cols-6 gap-4 items-center border-b pb-4">
                  ...
                  <div className='hidden md:block'>${product.price.toFixed(2)}</div>
                  <div className=" hidden md:flex items-center justify-between">
                    <div>${(product.price * quantities[product.id]).toFixed(2)}</div>
    ...
    <div className="space-y-6">
      ...
      <div className="border-b pb-4 flex justify-between">
        ...
        <p><span>Shipping to CA.</span></p>
           <button className="text-blue-500 underline">Change address</button>
        </div>
      </div>
      </div>
      ...
      <div className="py-3">
        <div className="flex justify-between">
          ...
          <span className="text-xl font-medium text-red-500">${subtotal.toFixed(2)}</span>
        </div>
      </div>
